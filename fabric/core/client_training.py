...
from .training import (
    build_criterion, build_model, make_loader, resolve_device, set_seed,
    train_one_epoch,
)
...
def result_row(condition: Condition, fold: int, out_dir: Path, metrics: dict, pred_df: pd.DataFrame, seconds: float) -> dict:
